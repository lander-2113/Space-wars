...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # get rid of bullets that have dsiappeared.
    for bullet in bullets.copy():
        if bullet.rect.bottom <= 0:
            bullets.remove(bullet)

    check_bullet_alien_collions(ai_settings, screen, stats, sb, ship, aliens, bullets)

def check_bullet_alien_collions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Respond to bullet-alien collions."""
    # remove any bullets-alien that have collided.
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if pygame.sprite.spritecollideany(ship, aliens):
        # this detects ship and alien hit.
        audio.ship_collision()
        sleep(2)
